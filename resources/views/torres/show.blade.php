            ...
            <div class="modal-content">
                ...
                <div class="modal-body scrollable-cards">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p><strong>Tipo:</strong> <span id="dispositivo-tipo"></span></p>
                            <p><strong>Hostname:</strong> <span id="dispositivo-nombre"></span></p>
                            <p><strong>Latitud:</strong> <span id="dispositivo-latitud"></span></p>
                            <p><strong>Longitud:</strong> <span id="dispositivo-longitud"></span></p>
                            <p><strong>Ubicación:</strong> <a href="" id="dispositivo-ubicacion" target="_blank">Ver
                                    en
                                    Google Maps</a></p>
                            <p><strong>IP:</strong> <span id="dispositivo-ip"></span></p>
                            <p><strong>SSID:</strong> <span id="dispositivo-ssid"></span></p>
                            <p><strong>Usuario:</strong> <span id="dispositivo-usuario"></span></p>
                            <p><strong>Password:</strong> <span id="dispositivo-password"></span> <button
                                    id="toggle-password" class="btn btn-sm btn-outline-primary">Ver</button></p>
                            <p><strong>Número de Cliente:</strong> <span id="dispositivo-numero_de_cliente"></span></p>
                            <p><strong>Marca:</strong> <span id="dispositivo-marca"></span></p>
                            <p><strong>Modelo:</strong> <span id="dispositivo-modelo"></span></p>
                            <p><strong>Comentario:</strong> <span id="dispositivo-comentario"></span></p>
                            <p><strong>Estado:</strong> <span id="dispositivo-estado"></span></p>
                            <p><strong>Radio de Transmisión:</strong> <span id="dispositivo-radio_transmision"></span></p>
                        </div>
                    </div>
                </div>
